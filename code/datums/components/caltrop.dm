...
/datum/component/caltrop/proc/on_entered(datum/source, atom/movable/arrived, atom/old_loc, list/atom/old_locs)
	...
	if (!(flags & CALTROP_BYPASS_SHOES))
		if (((digitigrade_fan.wear_suit?.body_parts_covered | digitigrade_fan.w_uniform?.body_parts_covered | digitigrade_fan.shoes?.body_parts_covered) & FEET) | HAS_TRAIT(digitigrade_fan, TRAIT_HARDENED_SOLES))
			return
